 ...
 */
public class MyVirtualJoystickView extends RelativeLayout implements AnimationListener,
    ...
    public MyVirtualJoystickView(Context context) {
        super(context);
        initVirtualJoystick(context);
        topicName = "~cmd_vel";
    }

    public MyVirtualJoystickView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initVirtualJoystick(context);
        topicName = "~cmd_vel";
    }

    public MyVirtualJoystickView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void onContactMove(float x, float y) {
        ...
        if (holonomic) {
            ...
            publishVelocity(normalizedMagnitude * Math.cos(contactTheta * Math.PI / 180.0),
                    normalizedMagnitude * Math.sin(contactTheta * Math.PI / 180.0),normalizedMagnitude,contactTheta);
        }
    ...
    private void publishVelocity(double linearVelocityX, double linearVelocityY,double linearVelocityZ,
                                 double angularVelocityZ) {
        currentVelocityCommand.getLinear().setX(linearVelocityX);
        currentVelocityCommand.getLinear().setY(linearVelocityY);
        currentVelocityCommand.getLinear().setZ(linearVelocityZ);
        currentVelocityCommand.getAngular().setX(0);
        currentVelocityCommand.getAngular().setY(0);
        currentVelocityCommand.getAngular().setZ(angularVelocityZ);
    }
